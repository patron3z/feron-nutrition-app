...
import { flattenChildren, pickChildren, isInstanceOfComponent } from '../children';
import { create } from '../display-names';
import { filterNull } from '../filter-null';

const createIosMenu = Menu => {
  const Trigger = create(_ref => {
    let {
      children,
      style,
      asChild,
  ...
  const Auxiliary = create(_ref2 => {
    let {} = _ref2;
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'Auxiliary');
  const Group = create(_ref3 => {
    let {
      children
    } = _ref3;
    return /*#__PURE__*/React.createElement(React.Fragment, null, children);
  }, 'Group');
  const Content = create(_ref4 => {
    let {
      children
    } = _ref4;
...
If you want to use a custom component as your <Content />, you can use the create() method. But you still need to pass all items as children of <Content />.`);
  ...
  const ItemIcon = create(_ => {
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'ItemIcon');
  const ItemImage = create(_ => {
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'ItemImage');
  const ItemSubtitle = create(_ref6 => {
    let {
      children
    } = _ref6;
...
<SubTrigger>
  ...
  const Sub = create(_ => /*#__PURE__*/React.createElement(React.Fragment, null), 'Sub');
  const SubContent = create(_ => /*#__PURE__*/React.createElement(React.Fragment, null), 'SubContent');
  const Preview = create(_ => {
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'Preview');
  Preview.defaultProps = {
    isResizeAnimated: true
  };
  const CheckboxItem = create(_ref9 => {
    let {} = _ref9;
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'CheckboxItem');
  const Label = create(_ref10 => {
    let {
      children
    } = _ref10;
  ...
  const Root = create(props => {
    ...
    const content = (_pickChildren$targetC = pickChildren(props.children, Content).targetChildren) === null || _pickChildren$targetC === void 0 ? void 0 : _pickChildren$targetC[0];
    const callbacks = {};
    ...
    const getItemFromChild = (child, index) => {
      ...
      if (typeof child.props.children == 'string') {
        ...
        const titleChild = pickChildren(child.props.children, ItemTitle).targetChildren;
...
3. OR, if you are using a horizontal Group with icons only, pass an empty string: <${Menu}.ItemTitle textValue="" />`);
        ...
        const subtitleChild = pickChildren(child.props.children, ItemSubtitle).targetChildren;
        ...
        const iconChildren = pickChildren(child.props.children, ItemIcon).targetChildren;
        ...
        if (iconChildren !== null && iconChildren !== void 0 && (_iconChildren$ = iconChildren[0]) !== null && _iconChildren$ !== void 0 && _iconChildren$.props.iosIconName || iconChildren !== null && iconChildren !== void 0 && (_iconChildren$2 = iconChildren[0]) !== null && _iconChildren$2 !== void 0 && _iconChildren$2.props.ios) {
          ...
          const imageChild = (_pickChildren$targetC2 = pickChildren(child.props.children, ItemImage).targetChildren) === null || _pickChildren$targetC2 === void 0 ? void 0 : _pickChildren$targetC2[0];
          ...
          if (imageChild) {
            if (imageChild.props.source) {
              ...
              if (typeof source === 'object' && 'uri' in source && source.uri) {
                ...
                const imageValue = Image.resolveAssetSource(typeof imageChild.props.source === 'object' && 'src' in imageChild.props.source ? {
    ...
    const mapItemsChildren = children => {
      return Children.map(flattenChildren(children), (child, index) => {
        if (isInstanceOfComponent(child, Item)) {
          ...
          const triggerItemChild = (_pickChildren$targetC3 = pickChildren(child.props.children, SubTrigger).targetChildren) === null || _pickChildren$targetC3 === void 0 ? void 0 : _pickChildren$targetC3[0];
          const triggerItem = triggerItemChild && getItemFromChild(triggerItemChild, index);

          if (triggerItem) {
            var _pickChildren$targetC4;

            const nestedContent = (_pickChildren$targetC4 = pickChildren(child.props.children, SubContent).targetChildren) === null || _pickChildren$targetC4 === void 0 ? void 0 : _pickChildren$targetC4[0];

            if (nestedContent) {
              const nestedItems = mapItemsChildren(nestedContent.props.children).filter(filterNull);
          ...
          const groupTitle = (_pickChildren$targetC5 = pickChildren(child.props.children, Label).targetChildren) === null || _pickChildren$targetC5 === void 0 ? void 0 : (_pickChildren$targetC6 = _pickChildren$targetC5[0]) === null || _pickChildren$targetC6 === void 0 ? void 0 : _pickChildren$targetC6.props.children;
    ...
    const menuItems = mapItemsChildren(content === null || content === void 0 ? void 0 : content.props.children).filter(filterNull);
    const label = (_pickChildren$targetC7 = pickChildren(content === null || content === void 0 ? void 0 : content.props.children, Label).targetChildren) === null || _pickChildren$targetC7 === void 0 ? void 0 : (_pickChildren$targetC8 = _pickChildren$targetC7[0]) === null || _pickChildren$targetC8 === void 0 ? void 0 : _pickChildren$targetC8.props.children;
    let menuTitle = '';
    ...
    const Component = Menu === 'ContextMenu' ? ContextMenuView : ContextMenuButton;
    const preview = (_pickChildren$targetC9 = pickChildren(content === null || content === void 0 ? void 0 : content.props.children, Preview).targetChildren) === null || _pickChildren$targetC9 === void 0 ? void 0 : _pickChildren$targetC9[0];
    ...
    const auxiliary = Menu === 'ContextMenu' ? (_pickChildren = pickChildren(content === null || content === void 0 ? void 0 : content.props.children, Auxiliary)) === null || _pickChildren === void 0 ? void 0 : _pickChildren.targetChildren : undefined;
    ...
    return /*#__PURE__*/React.createElement(Component, _extends({
      ...
      renderPreview: Menu === 'ContextMenu' && preview && previewProps !== null && previewProps !== void 0 && previewProps.children ? () => {
        return /*#__PURE__*/React.createElement(React.Fragment, null, typeof (previewProps === null || previewProps === void 0 ? void 0 : previewProps.children) == 'function' ? previewProps.children() : previewProps === null || previewProps === void 0 ? void 0 : previewProps.children);
      } : undefined,
  ...
  const Separator = create(_ => {
    return /*#__PURE__*/React.createElement(React.Fragment, null);
  }, 'Separator');
  const ItemIndicator = create(_ => /*#__PURE__*/React.createElement(React.Fragment, null), 'ItemIndicator');
  const Arrow = create(_ => /*#__PURE__*/React.createElement(React.Fragment, null), 'Arrow');
  return {
    Root,
    Trigger,
    Content,
