...
<SubTrigger>
  ...
  2. OR, use the textValue prop on <${Menu}.Item textValue="Some value" />`);
    ...
    const mapItemsChildren = children => {
      return Children.map(flattenChildren(children).map(item => {
        ...
        if (isInstanceOfComponent(_child, Item)) {
          ...
          if (item) {
            ...
            const menuState = child.props.value;
            const currentState = menuState === true ? 'on' : menuState === false ? 'off' : menuState;
            const hasItemIndicator = ((_pickChildren$targetC2 = pickChildren(child.props.children, ItemIndicator).targetChildren) === null || _pickChildren$targetC2 === void 0 ? void 0 : _pickChildren$targetC2[0]) !== undefined;
            let image = icon;
    ...
    const label = (_pickChildren$targetC5 = pickChildren(content === null || content === void 0 ? void 0 : content.props.children, Label).targetChildren) === null || _pickChildren$targetC5 === void 0 ? void 0 : (_pickChildren$targetC6 = _pickChildren$targetC5[0]) === null || _pickChildren$targetC6 === void 0 ? void 0 : _pickChildren$targetC6.props.children;
    let menuTitle = '';
    ...
    return /*#__PURE__*/React.createElement(MenuView, {
      title: menuTitle,
      style: props.style,
  ...
  const Preview = create(_ => /*#__PURE__*/React.createElement(React.Fragment, null), 'Preview');
