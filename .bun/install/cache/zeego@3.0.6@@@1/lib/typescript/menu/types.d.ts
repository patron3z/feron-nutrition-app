...
import type { ContextMenuView, MenuAuxiliaryPreviewConfig, ContextMenuButton, ImageOptions } from 'react-native-ios-context-menu';
...
export type MenuContentProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Content> & {
    children: React.ReactNode;
};
export type ContextMenuContentProps = Not<MenuContentProps, 'side' | 'align' | 'sideOffset'>;
export type MenuGroupProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Group> & {
    children: React.ReactNode;
    style?: ViewStyle;
    /**
     * iOS-only
...
export type MenuItemProps = Omit<React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Item>, keyof ItemBaseProps> & {
    children: React.ReactNode;
    style?: ViewStyle;
    /**
...
export type MenuItemImageProps = Omit<ComponentProps<'img'>, 'src' | 'height' | 'width' | 'ref'> & {
    /**
...
export type MenuSubTriggerProps = Omit<React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.SubTrigger>, keyof ItemBaseProps> & ItemBaseProps;
export type MenuSubProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Sub> & {
    children: React.ReactNode;
};
export type MenuSubContentProps = RadixDropdownMenu.MenuSubContentProps & Not<MenuContentProps, 'side' | 'align'>;
export type ContextMenuSubContentProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.SubContent> & ContextMenuContentProps & Pick<MenuContentProps, 'sideOffset'>;
...
export type MenuSeparatorProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Separator>;
export type MenuCheckboxItemProps = Omit<React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.CheckboxItem>, keyof ItemBaseProps | 'onCheckedChange'> & ItemBaseProps & {
    value: 'mixed' | 'on' | 'off' | boolean;
    onValueChange?: (state: 'mixed' | 'on' | 'off', prevState: 'mixed' | 'on' | 'off') => void;
    key: string;
    shouldDismissMenuOnSelect?: boolean;
};
export type MenuItemIndicatorProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.ItemIndicator> & {
    children?: React.ReactNode;
};
export type MenuLabelProps = React.ComponentPropsWithoutRef<typeof RadixDropdownMenu.Label> & {
    children: string | React.ReactNode;
};
