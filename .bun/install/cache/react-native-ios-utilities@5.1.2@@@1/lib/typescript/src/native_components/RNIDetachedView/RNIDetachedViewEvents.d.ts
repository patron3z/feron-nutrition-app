...
export type OnContentViewDidDetachEvent = BubblingEventHandler<OnContentViewDidDetachEventPayload>;
export type OnViewDidDetachFromParentPayload = Readonly<{}>;
export type OnViewDidDetachFromParentEvent = BubblingEventHandler<OnViewDidDetachFromParentPayload>;
//# sourceMappingURL=RNIDetachedViewEvents.d.ts.map