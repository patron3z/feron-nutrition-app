...
export type RNIDetachedViewContentInheritedProps = Pick<RNIDetachedViewProps, 'shouldEnableDebugBackgroundColors'>;
export type RNIDetachedViewContentBaseProps = {
    contentContainerStyle?: ViewStyle;
    isParentDetached?: boolean;
    detachedSubviewsMap?: DetachedSubviewsMap;
};
export type RNIDetachedViewContentProps = RNIWrapperViewProps & RNIDetachedViewContentInheritedProps & RNIDetachedViewContentBaseProps;
//# sourceMappingURL=RNIDetachedViewContentTypes.d.ts.map